...
class AdmsNewUser
{
    ...
    /** @var string $url Recebe oa URL com endereco para o usuário confirmar o e-mail */
    private string $url;
    ...
    private function contentEmailHtml(): void
    {
        ...
        $this->emailData['contentHtml'] .= "Para que possamos liberar o seu cadastro em nosso sistema, ";
        $this->emailData['contentHtml'] .= "solicitamos a confirmação do e-mail clicanco no link abaixo: <br><br>";
        $this->emailData['contentHtml'] .= "<a href='{$this->url}'>{$this->url}</a><br><br>";
        $this->emailData['contentHtml'] .= "Esta mensagem foi enviada a você pela empresa RRSECCO.<br>"; 
        $this->emailData['contentHtml'] .= "Você está recebendo porque está cadastrado no banco de dados da empresa RRSECCO. "; 
        $this->emailData['contentHtml'] .= "Nenhum e-mail enviado pela empresa RRSECCO tem arquivos anexados ou solicita o preenchimento de senhas e informações cadastrais.<br><br>"; 
    }
    ...
    private function contentEmailText(): void
    {
        ...
        $this->emailData['contentHtml'] .= $this->url . "\n\n";
        $this->emailData['contentText'] .= "Esta mensagem foi enviada a você pela empresa RRSECCO.\n";  
        $this->emailData['contentText'] .= "Você está recebendo porque está cadastrado no banco de dados da empresa RRSECCO.";  
        $this->emailData['contentText'] .= "Nenhum e-mail enviado pela empresa RRSECCO tem arquivos anexados ou solicita o preenchimento de senhas e informações cadastrais.\n\n";  
    }
}

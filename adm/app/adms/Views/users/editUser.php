            ...
            <form method="POST" action="" id="form-edit-user" class="form-adm">
                ...
                <div class="row-input">
                    <div class="column">
                        ...
                        <input type="text" name="name" id="name" class="input-adm" placeholder="Digite o nome completo"
                ...
                <div class="row-input">
                    ...
                    <div class="column">
                        ...
                        <input type="text" name="user" id="user" class="input-adm"
                            placeholder="Digite o usuário para acessar o administrativo" value="<?php echo $user; ?>"
                            required>
